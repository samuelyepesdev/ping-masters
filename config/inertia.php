...
return [
    ...
    */
    ...
    |
    | This project keeps pages under resources/js/pages (lowercase), not the
    | package default resources/js/Pages — override both sections below so
    | page-existence checks resolve correctly on case-sensitive filesystems.
    |
    */
